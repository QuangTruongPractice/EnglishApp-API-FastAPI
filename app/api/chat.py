...
async def analyze_usage(req: AnalyzeRequest):
    """Phân tích cách sử dụng từ vựng trong văn bản"""
    t0 = time.time()
...
async def chat_with_friend(
    ...
    """Xử lý trò chuyện với AI (hỗ trợ cả văn bản và âm thanh)"""
    t0 = time.time()
    
    # Xử lý làm mới lịch sử chat
    if reset:
